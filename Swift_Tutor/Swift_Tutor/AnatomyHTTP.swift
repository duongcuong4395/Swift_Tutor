...
/*
 An HTTP request will usually have:
...
/*
 All data structures that conform to the RequestProtocol would inherit a generic implementation that composes a URLRequest?
 And do that by creating a protocol extension that provides a default implementation.
 */
